...
# Click "🎓 Workshop - 03 Html Reports" → "Build Now"
```
...
2. **Click "New Item"**
3. **Enter job name**: `03 Html Reports - Production`
4. **Select "Pipeline"** and click "OK"

#### Step 2: Configure Pipeline
1. **Description**: "Complete 03 html reports pipeline with testing and deployment"
2. **Pipeline section**:
