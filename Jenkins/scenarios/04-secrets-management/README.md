...
# Click "🎓 Workshop - 04 Secrets Management" → "Build Now"
```
...
2. **Click "New Item"**
3. **Enter job name**: `04 Secrets Management - Production`
4. **Select "Pipeline"** and click "OK"

#### Step 2: Configure Pipeline
1. **Description**: "Complete 04 secrets management pipeline with testing and deployment"
2. **Pipeline section**:
